    ...
    <>
      ...
      <article>
        ...
        <Section>
          ...
          <P>
            어느 정도 복무를 오래 한 선임들은 '환경은 충분하지만 목표를 관리하기
            어렵다'라는 의견이었습니다.
          </P>
          <P>
        ...
        <Section>
          ...
          <P>
            총 2가지의 가설을 세웠고, 인터뷰 결과, 개발시간등을 고려해 2번
            가설을 먼저 검증하고자 했습니다.
          </P>
          <H4>
            <B color="var(--grey400)">
        ...
        <Section>
          ...
          <P>
            여러 고민과 인터뷰 끝에 실패의 원인을 하나로 정의했습니다. '배가
            산으로 갔다'
          </P>
          <P>
            '장병'들의 목표관리를 위한 제품를 기획했지만, 제품을 개발하면서
            목표관리가 필요한 사람들로 타겟을 넓혔습니다.
          </P>
          <P>
          ...
          <P>
            1. 장병들이 타겟임으로 입대, 전역일을 기준으로 목표를 설정 가능하게
            <br />
            한다. <br />
            2. Key Result가 필요없다는 의견. 퍼널을 삭제함으로서 Depth를 줄인다.{" "}
            <br />
            3. Push 알림으로 계속해서 사용자에게 넛지를 준다. <br />첫 시도는
            실패했지만 반복적 개선작업을 통해 문제를 해결하고자 합니다.
          </P>
        </Section>
        <FloatingButton
          icon={"bulb"}
