      ...
      <article>
        ...
        <Section>
          ...
          <P>
            ...
            있기 때문이죠. 그런데 만약 오염 없이 웨이퍼를 이송할 수 있다면, 공정
            효율이 획기적으로 증가할 겁니다. 그래서 우리는 프로토타입 장비
            개발을 통해 이 가설을 증명하기로 했습니다.
            <br />
            <br />
          </P>
          <StyledImage src={A1} />
        ...
        <Section>
          <H2>문제</H2>
          <P>
            기술적으로 풀어야 할 문제가 크게 두가지 정도 있었습니다.
            <br />
            <br />
            <B>첫째, 안정적으로 챔버를 회전</B>
            <br />
        ...
        <Section>
          ...
          <P>
            ...
            ③ 와이어 커팅 <br />
            ④ 용접 <br />
            <br />약 3개월의 제작을 마무리하고 최종 장비를 조립했습니다.
            <br /> <br />
          </P>
          <StyledImage src={A7} />
          <StyledImage src={A8} />
