      ...
      <article>
        ...
        <Section>
          ...
          <P>
            ...
            <br />
            <br />
            ‘내가 받을 수 있는지 몰라서'를 초점에 두었습니다. 내가 진짜로 받을
            수 있는 복지를 알려준다면 복지 신청까지 자연스레 진행될거라
            생각했습니다.
            <br />
            <br />
        ...
        <Section>
          ...
          <P>
            ...
            볶다에서 모든 업무를 한 번에 처리할 수 있습니다. <br />
            <br />
        ...
        <Section>
          <H2>Closing Notes</H2>
          <P>
            검색 프로세스의 개선으로 정확도를 60%가량 높이고, 평균 20분의 시간
            단축을 해냈지만, 핵심 기능인 간편신청을 구현하지 못해 문제를
            완벽하게 풀지 못했습니다.
            <br />
            <br />
