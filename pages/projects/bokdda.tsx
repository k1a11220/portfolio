      ...
      <article>
        ...
        <Section>
          ...
          <P>
            ...
            <br />
            <B>□ 3개의 검색 기준을 6개로 증가.</B> <br />
            복지로 간편검색에 비해 정확도가 약 60% 증가했고, 검색 후 다시 조건을
            찾아보는 과정을 줄일 수 있었습니다.
            <br />
            <br />
          </P>
        ...
        <Section>
          <H2>Closing Notes</H2>
          <P>
            검색 프로세스의 개선으로 60% 이상의 정확도 향상과 평균 20분의 시간
            단축을 해냈지만, 핵심 기능인 간편신청을 완성하지 못해 문제를
            완벽하게 풀지 못했습니다.
            <br />
            <br />
            간편신청은 정부24를 포함해 약 4개 기관의 협조가 필요한데, 보안과
            안전상의 이유로 진행이 어렵다는 답변을 받아 중단되었습니다. 하지만
            프로토타입으로 진행했던 사용성 테스트의 지표를 통해 볶다의 솔루션이
            가능성이 있다는 것을 알게 되었습니다.
            <br />
            <br />
            비록 완벽하게 문제를 해결하지 못했으나 사용자의 입장에서 문제를
            정의하고 최적의 솔루션을 찾는 과정을 통해 어떤 지표로 디자인,
